...
Code and data to accompany Galligan, B. P., McManus, M. C., and Balouskus, R. G. Drivers of Winter Flounder subpopulation catch rates. This project analyzes 25 years of data from a fyke net (fixed gear) survey of Winter Flounder breeding subpopulations in three Rhode Island coastal ponds to predict subpopulation abundance and gain insight into fish behavior as it relates to environmental and sampling variables.
...
To replicate the analysis, the R scripts contained here should be run in sequential order, i.e., beginning with 01_load-packages.R and ending with 04_rfm.R.
